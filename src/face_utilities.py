...
def align_face(
    ...
    aligned_image, out_of_bounds, rgba_aligned_image = (FaceAligner(
        ...
        desired_height=desired_height).align(cv_image, left_eye_point, right_eye_point))
...
def get_binary_mask(mp_image: mp.Image, method: str = "selfie") -> ndarray[Any, dtype[Any]]:
    ...
    A 3-dimensional numpy array is returned. The background is white, the foreground is black. (255, 255, 255) and
    (0, 0, 0) respectively.
    :param mp_image: The input image as a MediaPipe Image object.
