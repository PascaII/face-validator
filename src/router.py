...
async def process_image(
        ...
        mask_method: str = Query("multiclass", alias="mask_method", description="Method used for background removal (multiclass (more accurate, slower), selfie (faster, less accurate)")
):
    try:
